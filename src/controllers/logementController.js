...
const getLogement = async (req, res) => {
    ...
    // const page = req.query.page; // Récupère la ville depuis les paramètres de la route
    ...
    const url = `https://www.padmapper.com/${encodeURIComponent(type)}/${encodeURIComponent(city)}`;
